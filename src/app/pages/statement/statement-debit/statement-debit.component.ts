...
@Component({
  selector: 'app-statement-debit',
  templateUrl: './statement-debit.component.html',
  styleUrls: ['./statement-debit.component.css']
})
export class StatementDebitComponent implements OnInit {
  listtype ='statement'
  form: any =FormGroup;
  ...
  maxDate!: Date;
  url:string = config.statement.debit;
  exceldownurl:string = config.downloadstatement.debit;
