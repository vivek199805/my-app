...
@Component({
  selector: 'app-statement-airtel-cms',
  templateUrl: './statement-airtel-cms.component.html',
  styleUrls: ['./statement-airtel-cms.component.css']
})
export class StatementAirtelCmsComponent implements OnInit {
  ...
  download($event: any) {
    ...
    this.api.postdata(formdata, config.downloadstatement.airtelcms).subscribe((res: any) => {
      if (res.statuscode == 200) {
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'AirtelCms-Statement');
