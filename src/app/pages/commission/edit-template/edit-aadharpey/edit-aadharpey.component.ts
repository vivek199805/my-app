...
@Component({
  selector: 'app-edit-aadharpey',
  templateUrl: './edit-aadharpey.component.html',
  styleUrls: ['./edit-aadharpey.component.css']
})
export class EditAadharpeyComponent implements OnInit {
  data: any = null;
  filterDt: any = []
  Template_name: any;
  templateId:any;
