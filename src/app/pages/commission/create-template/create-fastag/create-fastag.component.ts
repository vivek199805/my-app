...
@Component({
  selector: 'app-create-fastag',
  templateUrl: './create-fastag.component.html',
  styleUrls: ['./create-fastag.component.css']
})
export class CreateFastagComponent implements OnInit {
  ...
  getadata() {
    ...
    this._auth.postdata(formdata, config.template.fastagoperator).subscribe((res: any) => {
