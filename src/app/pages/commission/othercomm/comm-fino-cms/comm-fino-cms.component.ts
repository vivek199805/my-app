...
@Component({
  selector: 'app-comm-fino-cms',
  templateUrl: './comm-fino-cms.component.html',
  styleUrls: ['./comm-fino-cms.component.css']
})
export class CommFinoCmsComponent implements OnInit {
  userAutoComData: any;
