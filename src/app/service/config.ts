...
export var config = {
  ...
  resendotp: "auth/verify/resendotponcall",
  ...
  changeuserpassword: "user/Profile/changepassword",
  ...
  paysprintwalletbalance:"dashboard/Wallet/mainbalance", 
  paysprintcashbalance:"dashboard/Wallet/cashbalance",
  deviceList:"user/permission/Permission/default_biometric",
  signup: {
  ...
  opration: {
    ...
    funddebit: "debit_fund/debit/debit",
    fundlisting:"statement/debitrequestlist",
    verify_debit:"debit_fund/debit/verify_debit",
    resendotp:"debit_fund/debit/resendotp"
  },
  tree: {
    ...
    getPartnerList: 'tree/treedistributor/partner_list',
  },
  kyc: {
  ...
  statement: {
    ...
    airtelcmslist:"statement/cms/list ",
    commissionearning:"statement/commission/list",
    commissionearningSup:"statement/commission/commissionlist",
    rcommissionearning:"statement/commission/retailerearned",
    ...
    claim:"dmt/remitter/refund/sendotp",
    claimrefund:"dmt/remitter/refund/claim",
    getreceipt:"statement/dmt/getreceipt"
  },
  ...
  cashfree_payout: {
    banklist: "payout/rzpayout/banklist",
    accountlist: "payout/rzpayout/accountlist",
    DeleteAccount: "payout/rzpayout/softdeleteaccount",
    changeAccountStatus: "payout/rzpayout/changeAccountStatus",
    addaccount: "payout/rzpayout/add",
    ApproveReject: "payout/rzpayout/approveDocs",
    uploaddoc: "payout/rzpayout/uploaddocument",
    dotxn: "payout/rzpayout/dotransaction",
    updateDetils: "payout/rzpayout/updateAccount",
    txnlist: "payout/rzpayout/transactionlist",
    txnStatus: "payout/rzpayout/status",
    verification: "payout/rzpayout/bankverify",
    viewUploadDoc:"payout/rzpayout/viewuploaddocument"
  },
  banner: {
  ...
  downloadstatement: {
    ...
    airtelcms : "statement/cms/download",
    commissionearning : "statement/commission/download",
  },
  ...
  userlist:{
    ...
    UserListByUser : "user/dropdown/userlist/userlistbyuser",
  }, 
  userListDropDown: {
  ...
  userTypeList1:"debit_fund/Userlist/getusertype",
  ...
  template: {
    ...
    deleteTemplate:  'user/commission/template/deleterow'
  },
  product: {
  ...
  product1: {
    ...
    listproduct: "products/purchase/list",
    request: "products/purchase/order",
    statusrequest: "products/purchase/status",
    requestlist: "products/purchase/list",
    createPackage: 'products/package/create',
    checkStock: 'products/product/stockavailable',
    userListlower: "products/purchase/userlist",
    requestseller: "products/purchase/resell",
    getService: 'products/product/allservices',
  }, 
   airtelcms:{
    generateurl:'cms/cms/generateurl'
  },
